...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; David Chandra, 2022 -  <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script src="<?= base_url('assets/adm/'); ?>js/sweetalert2.all.min.js"></script>
<script src="<?= base_url('assets/adm/'); ?>js/myscript.js"></script>
